  ...
  public static final class Builder extends
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage
        ...
        internalGetEndorsementFieldBuilder();
      }
    }
    @java.lang.Override
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              input.readMessage(
                  internalGetEndorsementFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 802: {
              input.readMessage(
                  internalGetBlockProposalFieldBuilder().getBuilder(),
                  extensionRegistry);
              msgCase_ = 100;
              break;
            } // case 802
    ...
    public com.github.iotexproject.grpc.types.Endorsement.Builder getEndorsementBuilder() {
      bitField0_ |= 0x00000002;
      onChanged();
      return internalGetEndorsementFieldBuilder().getBuilder();
    }
    /**
     * <code>.iotextypes.Endorsement endorsement = 2;</code>
     */
    ...
    public com.github.iotexproject.grpc.types.BlockProposal.Builder getBlockProposalBuilder() {
      return internalGetBlockProposalFieldBuilder().getBuilder();
    }
    /**
     * <code>.iotextypes.BlockProposal blockProposal = 100;</code>
     */
    ...
    private com.google.protobuf.SingleFieldBuilder<
        ...
        internalGetBlockProposalFieldBuilder() {
      if (blockProposalBuilder_ == null) {
        if (!(msgCase_ == 100)) {
          msg_ = com.github.iotexproject.grpc.types.BlockProposal.getDefaultInstance();
        }
